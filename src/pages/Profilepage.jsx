            ...
            <div className="px-6">
              <div className="flex flex-wrap justify-center">
                ...
                <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                  <div className="py-6 px-3 mt-32 sm:mt-0">
                    <button
                      className="bg-[#636AE8] active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150"
                      type="button"
                    >
                      POST
                    </button>
                ...
                <div className="w-full lg:w-4/12 px-4 lg:order-1">
                  <div className="flex justify-center py-4 lg:pt-4 pt-8">
                    ...
                    <div className="mr-4 p-3 text-center">
                      ...
                      <span className="text-sm text-blueGray-400">Tales</span>
                    </div>
              ...
              <div className="text-center mt-12">
                ...
                <div className="mb-2 text-blueGray-600">
                  ...
                  Dr Akhilesh Das Gupta Institue of Professional Studies
                </div>
              </div>
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">
                    <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                      An artist of considerable range, Kanak the name taken by
                      Melbourne-raised, Brooklyn-based Nick Murphy writes,
                      performs and records all of his own music, giving it a
                      warm, intimate feel with a solid groove structure. An
                      artist of considerable range.
                    </p>
                    <a href="#pablo" className="font-normal text-[#636AE8]">Show more</a>
                  </div>
                </div>
              </div>
            </div>
